...
from custom_zotify.utils import AudioFormat, ImageSize, Quality
...
SYSTEM_PATHS = {
    "win32": Path.home().joinpath("AppData/Roaming/Custom_zotify"),
    "darwin": Path.home().joinpath("Library/Application Support/Custom_zotify"),
    "linux": Path(environ.get("XDG_CONFIG_HOME") or "~/.config")
    .expanduser()
    .joinpath("custom_zotify"),
}

LIBRARY_PATHS = {
    "album": Path.home().joinpath("Music/Custom_zotify Albums"),
    "podcast": Path.home().joinpath("Music/Custom_zotify Podcasts"),
    "playlist": Path.home().joinpath("Music/Custom_zotify Playlists"),
}
