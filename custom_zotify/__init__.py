...
import google.protobuf.message  # Add this import
...
from custom_zotify.utils import Quality
...
class Session(LibrespotSession):
    ...
    def authenticate(self, credential: Authentication.LoginCredentials) -> None:
        ...
        Log in to the thing
        Args:
            credential: Account login credentials
        """
        try:
            ...
            raise RuntimeError(
                "Authentication failed - Protobuf decode error. Try clearing credentials and logging in again."
            ) from e
        except Exception as e:
