...
from custom_zotify.file import LocalFile
...
class Track(PlayableContentFeeder.LoadedStream, Playable):
    ...
    def __default_metadata(self) -> list[MetadataEntry]:
        ...
        cover_url = IMG_URL + bytes_to_hex(self.cover_images[0].file_id) if self.cover_images else None
        return [
            ...
            MetadataEntry("cover_url", cover_url), 
            MetadataEntry(
